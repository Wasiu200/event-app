      ...
      <section className="container">
        <div>
          ...
          <div className="contain">
            ...
            <hr style={{ margin: "30px", color: "grey" }} />

            <h1>Select Ticket Type:</h1>
            <div className="container1">
              <div
                className={`amount ${
                  selectedTicket === "FREE" ? "selected-blue" : ""
                }`}
              ...
              <div
                className={`amount ${
                  selectedTicket === "REGULAR" ? "selected-blue" : ""
                }`}
              ...
              <div
                className={`amount ${
                  selectedTicket === "VIP" ? "selected-blue" : ""
                }`}
            ...
            {showAlert && (
              <div className="alert-box">
                <p>Please select a ticket type before proceeding!</p>
